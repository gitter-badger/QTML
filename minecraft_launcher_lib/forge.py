...
def install_forge_version(versionid: str, path: str, callback: Dict[str, Callable] = None, java: str = None, version_name=None) -> NoReturn:
    """
    Installs a forge version. Fore more information look at the documentation.
    """
    if callback is None:
        callback = {}
    FORGE_DOWNLOAD_URL = "http://bmclapi2.bangbang93.com/maven/net/minecraftforge/forge/{version}/forge-{version}-installer.jar"
    ...
    install_minecraft_version(version_data["minecraft"], path, callback=callback, version_name=version_name)
...
def list_forge_versions() -> List[str]:
    ...
    """
    MAVEN_METADATA_URL = "http://bmclapi2.bangbang93.com/maven/net/minecraftforge/forge/maven-metadata.xml"
