...
def get_store_information(token: str):
    """
...
def complete_login(client_id: str, client_secret: str, redirect_uri: str, auth_code: str):
    """
...
def complete_refresh(client_id: str, client_secret: str, redirect_uri: str, refresh_token: str):
    """
